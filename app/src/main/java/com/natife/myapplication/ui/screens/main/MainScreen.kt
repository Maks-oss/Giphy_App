...
fun MainScreen(
    ...
    Column(
        ...
        val gifsFromServer = gifsFlowUiState.data?.collectAsLazyPagingItems()
        if (gifsFromServer?.loadState?.refresh is LoadState.Error) {
            Toast.makeText(
